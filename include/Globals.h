...
const char* firmware = "1.0.15"; // Firmware version
...
#define PCF8575_ADDRESS 0x20 // PCF8575 I2C address (confirmed via I2C bus scan; default 0x20, A0-A2 all strapped low)
